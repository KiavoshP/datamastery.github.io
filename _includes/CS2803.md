...
**IMPORTANT**: All course-related electronic communication should be done through Canvas. If Canvas is not working and you wish to email a course instructor, include [CS803 Student] in the subject of course-related email, e.g., "Subject: [CS2803 Student] Exam 2 Question." Professors are deluged with email. If we don't respond, don't take it personally. Just resend your email with a friendly reminder.
